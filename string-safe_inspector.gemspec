...
lib_name = 'string-safe_inspector'

require_relative './lib/string/safe_inspector/version'
repository_url = "https://github.com/kachick/#{lib_name}"

Gem::Specification.new do |gem|
  gem.summary       = %q{Get `#inspect` without `exception` and `nil` possibilities}
  ...
  gem.license       = 'MIT'
  gem.name          = lib_name
  gem.version       = String::SafeInspector::VERSION

  gem.metadata = {
    'documentation_uri' => 'https://kachick.github.io/string-safe_inspector/',
